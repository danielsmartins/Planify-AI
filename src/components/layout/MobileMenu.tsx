...
import { LayoutDashboard, Tags, CreditCard, Wallet, BarChart2, Landmark, RotateCcw, Menu, X } from 'lucide-react';
...
export function MobileMenu() {
  ...
  return (
    <>
      ...
      {/* Sidebar / Drawer */}
      <div 
        className={`fixed top-0 right-0 h-full w-72 bg-slate-900 border-l border-slate-800 z-[100] transform transition-transform duration-300 ease-in-out ${
